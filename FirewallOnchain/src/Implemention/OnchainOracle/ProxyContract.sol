...
// // mock EACAggregatorProxy.sol:0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419
...
//      * instead which includes better verification information.
//      * 
//      * @notice 已经启用，使用latestRoundData代替
//      */
...
//      * @notice 替换聚合合约就是调用下面三个函数，这个函数Owner提议替换的Aggregator合约
//      */
...
//      * proposed
//      * @param _aggregator The new address for the aggregator contract
//      * @notice 这个函数验证被提议替换的Aggregator合约
//      */
...
//      * @notice Ken:允许owner更新accessController的地址
