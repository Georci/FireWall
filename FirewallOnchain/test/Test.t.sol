...
contract uintTest is Test {
    ...
    function testContinusAndDiscreteParam() public{
        ...
        vm.prank(deployer, deployer);
        testContract.test_attack(5);
    }

    function testGo() public{
        address deployer = 0xE03864F2673Ac19F9dB8512Cceb692817Cb1095E;
        bytes memory InitData_Registry = abi.encodeWithSignature("initialize(address)", deployer);
        emit log_named_bytes("InitData_Registry is :", InitData_Registry);
        bytes memory InitData_Router = abi.encodeWithSignature(
            "initialize(address,address)",
            0x0f88BCDA1E1413bE655179623Cc465e5a5835Ed4,
            0xE03864F2673Ac19F9dB8512Cceb692817Cb1095E
        );
        emit log_named_bytes("InitData_Router is :", InitData_Router);

        bytes memory addModuledata1 = abi.encodeWithSignature(
            "addModule(address,address,string,bool)",
            0x178Fc46a6417532E58cF132cCFC2Ef874af6FBCA,
            0xE03864F2673Ac19F9dB8512Cceb692817Cb1095E,
            "param detect",
            true
        );
        emit log_named_bytes("addModuledata1 is :", addModuledata1);

        bytes memory addModuledata2 = abi.encodeWithSignature(
            "addModule(address,address,string,bool)",
            0xe7C87c3E40e1a1F580C33A3B87d07379d141b47A,
            0xE03864F2673Ac19F9dB8512Cceb692817Cb1095E,
            "black detect",
            true
        );
        emit log_named_bytes("addModuledata2 is :", addModuledata2);
