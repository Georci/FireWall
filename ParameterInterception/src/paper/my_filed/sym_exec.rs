...
pub async fn sym_exec(
    ...
    println!("_target_address {:?}", _target_address);
    println!("_index {:?}", _index);
    println!("_min_value {:?}", _min_value);
    println!("_max_value {:?}", _max_value);
    // 记录时间
...
// #[tokio::test]
// async fn test() {
//     //0xf233caad429934a954bea516744811bc8a2cbb4492cf99ee17b49130f73ecdf4
//     sym_exec(
//         // "wss://lb.drpc.org/ogws?network=sepolia&dkey=AvZwUDJNQ0H-rfHFUNlC228dOWBjNHER76RXhkHL9tz4",
